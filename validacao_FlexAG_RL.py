...
atrib_acad=list(np.array(pd.read_csv('atrib_AG_RL_acad_VC_.csv',delimiter =',',encoding='utf-8')).flatten())
atrib_inst=list(np.array(pd.read_csv('atrib_AG_RL_inst_VC_.csv',delimiter =',',encoding='utf-8')).flatten())
atrib_engaj=list(np.array(pd.read_csv('atrib_AG_RL_engaj_VC_.csv',delimiter =',',encoding='utf-8')).flatten())
atrib_financeiro=list(np.array(pd.read_csv('atrib_AG_RL_financeiro_VC_.csv',delimiter =',',encoding='utf-8')).flatten())
atrib_pessoal=list(np.array(pd.read_csv('atrib_AG_RL_pessoal_VC_.csv',delimiter =',',encoding='utf-8')).flatten())
atrib_curso=list(np.array(pd.read_csv('atrib_AG_RL_curso_VC_.csv',delimiter =',',encoding='utf-8')).flatten())
...
print(Relatorio)
np.savetxt('Classi_peso_RL_peso.csv',Relatorio, delimiter=',',fmt='%s')