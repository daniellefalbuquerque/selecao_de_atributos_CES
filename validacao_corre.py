...
print(Relatorio)
np.savetxt('so_corre40.csv',Relatorio, delimiter=',',fmt='%s')
...
np.savetxt('so_corre20.csv',Relatorio, delimiter=',',fmt='%s')
...
np.savetxt('so_corre60.csv',Relatorio, delimiter=',',fmt='%s')
