...
#df2=df2[tab_corre.iloc[:20,0]]


atrib_DT=list(np.array(pd.read_csv('atrib_AG_DT20.csv',delimiter =',',encoding='utf-8')).flatten())
atrib_RL=list(np.array(pd.read_csv('atrib_AG_RL20.csv',delimiter =',',encoding='utf-8')).flatten())
atrib_RF=list(np.array(pd.read_csv('atrib_AG_RF20.csv',delimiter =',',encoding='utf-8')).flatten())
...
np.savetxt('Classi_sem_peso20.csv',Relatorio, delimiter=',',fmt='%s')
...
df2= df2.drop(columns=['Evasao'],axis=1)
#tab_corre = pd.read_csv('corre_importancia.csv',delimiter =',',encoding='utf-8')
#df2=df2[tab_corre.iloc[:40,0]]


atrib_DT=list(np.array(pd.read_csv('atrib_AG_DT40.csv',delimiter =',',encoding='utf-8')).flatten())
atrib_RL=list(np.array(pd.read_csv('atrib_AG_RL40.csv',delimiter =',',encoding='utf-8')).flatten())
atrib_RF=list(np.array(pd.read_csv('atrib_AG_RF40.csv',delimiter =',',encoding='utf-8')).flatten())
...
np.savetxt('Classi_sem_peso40.csv',Relatorio, delimiter=',',fmt='%s')
...
df2= df2.drop(columns=['Evasao'],axis=1)
#tab_corre = pd.read_csv('corre_importancia.csv',delimiter =',',encoding='utf-8')
#df2=df2[tab_corre.iloc[:60,0]]


atrib_DT=list(np.array(pd.read_csv('atrib_AG_DT60.csv',delimiter =',',encoding='utf-8')).flatten())
atrib_RL=list(np.array(pd.read_csv('atrib_AG_RL60.csv',delimiter =',',encoding='utf-8')).flatten())
atrib_RF=list(np.array(pd.read_csv('atrib_AG_RF60.csv',delimiter =',',encoding='utf-8')).flatten())
...
np.savetxt('Classi_sem_peso60.csv',Relatorio, delimiter=',',fmt='%s')
