...
tab_selec.to_csv('atrib_AG_DT60_qq.csv',index=False)

time2.append(fim2-inicio2)
time5= pd.DataFrame(time2)
time5.to_csv('timeDT_AG60_qq.csv',index=False)
...
tab_selec.to_csv('atrib_AG_RL60_qq.csv',index=False)

time2.append(fim2-inicio2)
time5= pd.DataFrame(time2)
time5.to_csv('timeRL_AG60_qq.csv',index=False)
...
tab_selec.to_csv('atrib_AG_RF60_qq.csv',index=False)

time2.append(fim2-inicio2)
time5= pd.DataFrame(time2)
time5.to_csv('timeRF_AG60_qq.csv',index=False)
