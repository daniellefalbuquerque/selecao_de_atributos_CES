...
tab_selec.to_csv('atrib_AG_DT.csv',index=False)

time2.append(fim2-inicio2)
time5= pd.DataFrame(time2)
time5.to_csv('timeDT_AG.csv',index=False)
...
tab_selec.to_csv('atrib_AG_RL.csv',index=False)

time2.append(fim2-inicio2)
time5= pd.DataFrame(time2)
time5.to_csv('timeRL_AG.csv',index=False)
...
tab_selec.to_csv('atrib_AG_RF.csv',index=False)

time2.append(fim2-inicio2)
time5= pd.DataFrame(time2)
time5.to_csv('timeRF_AG.csv',index=False)
