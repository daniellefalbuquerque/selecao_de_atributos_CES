...
tab_selec.to_csv('atrib_AG_RL_acad_VC_.csv',index=False)
time2.append(fim2-inicio2)
time5= pd.DataFrame(time2)
time5.to_csv('timeRL.csv',index=False)
...
tab_selec.to_csv('atrib_AG_RL_inst_VC_.csv',index=False)
...
tab_selec.to_csv('atrib_AG_RL_engaj_VC_.csv',index=False)
...
tab_selec.to_csv('atrib_AG_RL_financeiro_VC_.csv',index=False)
...
tab_selec.to_csv('atrib_AG_RL_pessoal_VC_.csv',index=False)
...
tab_selec.to_csv('atrib_AG_RL_curso_VC_.csv',index=False)
