...
atrib_DT=list(np.array(pd.read_csv('atrib_AG_DT.csv',delimiter =',',encoding='utf-8')).flatten())
atrib_RL=list(np.array(pd.read_csv('atrib_AG_RL.csv',delimiter =',',encoding='utf-8')).flatten())
atrib_RF=list(np.array(pd.read_csv('atrib_AG_RF.csv',delimiter =',',encoding='utf-8')).flatten())
...
np.savetxt('Classi_sem_peso.csv',Relatorio, delimiter=',',fmt='%s')
