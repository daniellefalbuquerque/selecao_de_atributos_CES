...
def getFitnessRF(individual, X, y,vetorpeso):
    prob=vetorpeso
    num_col=len(X.columns)
    vetorbase = [1]*num_col
...
tab_selec.to_csv('atrib_AG_RL_acad_VC_corre.csv',index=False)
time2.append(fim2-inicio2)
time5= pd.DataFrame(time2)
time5.to_csv('timeRL_corre.csv',index=False)
...
tab_selec.to_csv('atrib_AG_RL_inst_VC_corre.csv',index=False)
...
tab_selec.to_csv('atrib_AG_RL_engaj_VC_corre.csv',index=False)
...
tab_selec.to_csv('atrib_AG_RL_financeiro_VC_corre.csv',index=False)
...
tab_selec.to_csv('atrib_AG_RL_pessoal_VC_corre.csv',index=False)
...
tab_selec.to_csv('atrib_AG_RL_curso_VC_corre.csv',index=False)
