...
atrib_acad=list(np.array(pd.read_csv('atrib_AG_DT_acad_VC_corre.csv',delimiter =',',encoding='utf-8')).flatten())
atrib_inst=list(np.array(pd.read_csv('atrib_AG_DT_inst_VC_corre.csv',delimiter =',',encoding='utf-8')).flatten())
atrib_engaj=list(np.array(pd.read_csv('atrib_AG_DT_engaj_VC_corre.csv',delimiter =',',encoding='utf-8')).flatten())
atrib_financeiro=list(np.array(pd.read_csv('atrib_AG_DT_financeiro_VC_corre.csv',delimiter =',',encoding='utf-8')).flatten())
atrib_pessoal=list(np.array(pd.read_csv('atrib_AG_DT_pessoal_VC_corre.csv',delimiter =',',encoding='utf-8')).flatten())
atrib_curso=list(np.array(pd.read_csv('atrib_AG_DT_curso_VC_corre.csv',delimiter =',',encoding='utf-8')).flatten())
...
print(Relatorio)
np.savetxt('Classi_peso_DT_peso_corre.csv',Relatorio, delimiter=',',fmt='%s')