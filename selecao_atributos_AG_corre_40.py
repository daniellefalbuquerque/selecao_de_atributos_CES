...
tab_selec.to_csv('atrib_AG_DT40.csv',index=False)

time2.append(fim2-inicio2)
time5= pd.DataFrame(time2)
time5.to_csv('timeDT_AG40.csv',index=False)
...
tab_selec.to_csv('atrib_AG_RL40.csv',index=False)

time2.append(fim2-inicio2)
time5= pd.DataFrame(time2)
time5.to_csv('timeRL_AG40.csv',index=False)
...
tab_selec.to_csv('atrib_AG_RF40.csv',index=False)

time2.append(fim2-inicio2)
time5= pd.DataFrame(time2)
time5.to_csv('timeRF_AG40.csv',index=False)
