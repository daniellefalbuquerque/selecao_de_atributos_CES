...
tab_selec.to_csv('atrib_AG_DT_acad_VC_.csv',index=False)
time2.append(fim2-inicio2)
time5= pd.DataFrame(time2)
time5.to_csv('timeDT.csv',index=False)
...
tab_selec.to_csv('atrib_AG_DT_inst_VC_.csv',index=False)
...
tab_selec.to_csv('atrib_AG_DT_engaj_VC_.csv',index=False)
...
tab_selec.to_csv('atrib_AG_DT_financeiro_VC_.csv',index=False)
...
tab_selec.to_csv('atrib_AG_DT_pessoal_VC_.csv',index=False)
...
tab_selec.to_csv('atrib_AG_DT_curso_VC_.csv',index=False)
