...
tab_selec.to_csv('atrib_AG_RF_acad_VC_corre.csv',index=False)
time2.append(fim2-inicio2)
time5= pd.DataFrame(time2)
time5.to_csv('timeRF_corre.csv',index=False)
...
tab_selec.to_csv('atrib_AG_RF_inst_VC_corre.csv',index=False)
...
tab_selec.to_csv('atrib_AG_RF_engaj_VC_corre.csv',index=False)
...
tab_selec.to_csv('atrib_AG_RF_financeiro_VC_corre.csv',index=False)
...
tab_selec.to_csv('atrib_AG_RF_pessoal_VC_corre.csv',index=False)
...
tab_selec.to_csv('atrib_AG_RF_curso_VC_corre.csv',index=False)
